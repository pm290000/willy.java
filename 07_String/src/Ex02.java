...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		//모두 대문자로 만들기(대문자와 소문자의 차이는 32 이다)
		...
		//		들어온 문자열과 현재 문자열과 같으면  true, 다르면 fase (대소문자 구별)
		...
		// 보통 입출력할 때 사용한다. (대소문자, 숫자만 가능, 영어이외의 글자는x)
		String str8 = "java";
		...
		// char 나 String이 들어오면 해당문자열에 char이나 String의 위치값을 알려준다.
		// 찾는 문자나 문자열이 없으면 -1
		String str10 = "ButteredReader";
		...
		// 'r'의 위치값을 찾아라
				...
				// 해당 문자열의 길이를 구해주다. (for문에 많이 사용된다.)
				String str11 = "abcABC23가나다";
				k1= str11.length();
				...
				// split(String regex, nt limit) String[]
				...
				// 15. toLowerCase() : 모든 대문자를 소문자로 변경 시킨다. 반환형은 String
				// 16. toUpperCase() : 모든 소문자를 대문자로 변경 시킨다.
			...
			//	System.out.println(bo1+1);		boolean형은 +를 할 수 없다.
				...
				// 20-1. Mrapper class :
				//	- 기본 자료형 형태를 가진 문자열을 진짜 자료형으로 변경시키는 클래스들
				...
				//20-4. 문자열을 float로 변경 : Float.parseloat
				// "숫자" => 0, "숫자f"=>X
				message = "3.14";
