...
public class Ex01 {
	public static void main(String[] args) {
		...
		su[1] = 200;
		su[2] = 'a';
		// su[3] = 3.14 ; // 큰 자료형은 작은 자료형에 저장 할 수 없다.
		su[3] = 300;
		su[1] = 100; // 데이터 중복가능, 현재 데이터가 있어도 저장 가능
		// su[4] = 500; // 방의 크기를 벗어나면 실행할 때 오류발생
		...
		// 개선된 for문 : 주로 배열이나 컬랙션에 사용된다.
		// 배열 전체에 대해서 정보 가공을 할 수 있으나 개별로는 가공 할 수 없다.
		for (int k : su) {
